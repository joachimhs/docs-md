...
docs.md is a documentation authoring tool and CLI. It reads Markdown files with YAML frontmatter from a `docs/` folder, serves them as a web application with editing and Git integration, and packages as a globally installable npm CLI. TESTING PART 4
